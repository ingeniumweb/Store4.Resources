...
IF (@ResourceTypeID > 0 AND @LanguageID > 0) BEGIN
	INSERT INTO @ResourcesTable (Name, Value, [Description])
		...
		SELECT N'Referral_Members_Rule_Message', N'Nedostaje ti još {0} član/ova u teamu da bi mogao koristiti Superbonus.<br />Minimalan broj članova = 12', N'You still miss {0} members in the team to be able to use Superbonus. <br /> Minimum number of members = 1' UNION ALL
