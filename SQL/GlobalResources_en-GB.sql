...
IF (@ResourceTypeID > = 0 AND @LanguageID > 0) BEGIN
	INSERT INTO @ResourcesTable (Name, Value)
		...
		SELECT N'Account_Controller_AccountExists', N'The account already exists with that email address or username' UNION ALL
		...
		SELECT N'Link_Authentication', N'This is not your account?' UNION ALL
		...
		SELECT N'Message_Received_Inquiry', N'Message Received Inquiry' UNION ALL
